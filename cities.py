...
def get_cities_words():
    theme_words = [
        ...
        "berlin", "mumbai", "beijing", "moscow", "cairo",
        "istanbul", "shanghai", "delhi", "rio de janeiro", "mexico city",
        "sydney", "rome", "toronto", "bangkok", "dubai",
        "chicago", "singapore", "seoul", "amsterdam", "hong kong",
        "jakarta", "barcelona", "buenos aires", "miami", "athens", "oslo",
